...
import { GlobalAlert } from '@/components/scada/GlobalAlert';
import {
  LayoutDashboard,
  BarChart3,
  FileText,
...
const allNavigation = [
  ...
  { name: 'Attack Lab', href: '/attack-lab', icon: FlaskConical, adminOnly: true },
  { name: 'Security', href: '/security', icon: Shield, adminOnly: true },
  { name: 'Historical', href: '/historical', icon: BarChart3, adminOnly: false },
...
export default function MainLayout() {
  ...
  const navigation = useMemo(() => {
    ...
    return allNavigation.filter((item) => admin || !item.adminOnly);
  }, [user?.role]);
